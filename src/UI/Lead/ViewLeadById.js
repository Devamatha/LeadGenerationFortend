...
import { getAllLeadsById } from "../../Services/employeeService"; // Import the API function
...
function ViewLeadById() {
 ...
 const [snackbarOpen, setSnackbarOpen] = useState(false);
  ...
  useEffect(() => {
    fetchAllLeadsbyId(id,Page, pageSize);
  }, [Page, pageSize]);
  const fetchAllLeadsbyId = async (id,Page, pageSize) => {
    try {
      const data = await getAllLeadsById(id,Page, pageSize);
